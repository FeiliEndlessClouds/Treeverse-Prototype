...
{
    public delegate void GameManagerReadyAction(GameManager gameManager);
    ...
    private void Awake()
    {
        GameInfos.Instance.activeGameManager = this;
    ...
    private void RefreshScore()
    {
        ...
        GameInfos.Instance.activeGameManager.guiManager.SetWinMessage(SeedersTeamStatus.NULL);
    }
    ...
    {
        localClient_PlayerEntity.fixedCam = !localClient_PlayerEntity.fixedCam;
    }
